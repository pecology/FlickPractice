  ...
  return {
    ...
    flickLayout: {
      hiragana: [
        ...
        { center: 'わ', left: 'を', up: 'ん' },
      ],
      alphabet: [
        { center: 'a', left: 'b', up: 'c' },
        { center: 'd', left: 'e', up: 'f' },
        { center: 'g', left: 'h', up: 'i' },
        { center: 'j', left: 'k', up: 'l' },
        { center: 'm', left: 'n', up: 'o' },
        { center: 'p', left: 'q', up: 'r', right: 's' },
        { center: 't', left: 'u', up: 'v' },
        { center: 'w', left: 'x', up: 'y', right: 'z' },
      ],
    },
    ui: {
      shakeIntensity: 5,
